...
$queryToRun = "select opis as Imie_Nazwisko,OfficePhone as Telefon , EmailAddress as 'E-Mail', Title as Stanowisko , Department as Dział ,  StreetAddress as Adres ,CONCAT(hex(LOWER(login)), '.jpg') as Zdjęcie  
