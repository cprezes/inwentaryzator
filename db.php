...
$DBDEF = array(
    'user' => Session::get("raporty_user"), #required
    'pwd' => Session::get("raporty_pass"), #required
    'db' => Session::get("raporty_db"), #optional, default DB
    'host' => Session::get("raporty_host"), #optional
    'port' => "", #optional
...
function print_header() {
    ...
    <?php } ?>
        ...
        <?php } ?>
                        <a href="?showcfg=1"></a>
    <?php } ?>
    <?php if ($_SESSION['is_logged']) { ?>  <a href="?<?php eo($xurl) ?>&logoff=1" onclick="logoff()"></a> <?php } ?>
